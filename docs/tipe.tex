...
elle est limité en temps : \emph{40ms}. L'espace de jeu est supposé continu (les
...
\\
Chaque joueur contrôle des unitées qu'il peut bouger et qui peuvent effectuer 3
actions :
\begin{itemize}
...
\end{itemize}
les unitées on une variable "HP" qui définit leur vie, c'est à dire que lorsqu'elle
atteint 0, les unitées sont tuées et ne sont plus jouables. Chaque action prends
un certain temps.
Le joueur gagnant et le dernier a avoir toutes ses unitées en vie.
\newpage
